...
if (isset($_POST['submit'])) {
    ...
    // set is_featured to 0 if it was unckecked
    ...
    if (!$title) {
        ...
        // delete existing thumbanil if new thumbail is available
        if ($thumbnail['name']) {
    ...
    if ($_SESSION['edit-post']) {
        // redirect to image form page if form was invalid
        ...
        // set thumbanil name if a new one was uploaded, else keep old thumbanil name
